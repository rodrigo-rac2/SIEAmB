...
| # | Item | Due | Notes |
|---|---|---|---|
| R1 | **Recomendar plano de hospedagem para o grupo** | **2026-09-01 (prometido "até amanhã")** | Pesquisa já feita no IMPLEMENTATION_PLAN: Supabase sa-east-1 (free→Pro $25/mo) + Vercel + Render/Railway ($0 até fase de pagamentos, depois ~US$30-40/mo). Falta empacotar em linguagem não técnica com custos em R$ e mandar no grupo |
